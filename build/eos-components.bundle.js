...
class EosAlert extends LitElement {
  ...
  render() {
    return html(_templateObject2(), this.type, this.scope, this.icon[this.type], this.title || 'hide', this.title, this.scope, this.close ? '' : html(_templateObject3(), this.closeAlert, this.type === 'danger' ? 'hide' : ''));
  }

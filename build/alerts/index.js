...
class EosAlert extends LitElement {
  ...
  render() {
    return html(_templateObject2(), this.type, this.scope, this.icon[this.type], this.title || 'hide', this.title, this.closeAlert, this.type === 'danger' ? 'hide' : '');
  }
